...
$on_mod(Loaded) {
  ...
  listenForSettingChanges<std::string>("macro_accuracy", [](std::string value) {
    auto& g = Global::get();
  ...
  listenForSettingChanges<int64_t>("frame_fixes_limit", [](int64_t value) {
    Global::get().frameFixesLimit = value;
  });

  listenForSettingChanges<bool>("lock_delta", [](bool value) {
    Global::get().lockDelta = value;
  });

  listenForSettingChanges<bool>("auto_stop_playing", [](bool value) {
