...
// Keybinds are now handled via built-in Geode keybind settings
...
void Global::updateKeybinds() {
  // In Geode 5.x, keybinds for game buttons are managed by the engine
  // We still track held buttons via CCKeyboardDispatcher hook
}
